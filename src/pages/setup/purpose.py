...
def purpose_setup():
    st.subheader(
        "Goal/Purpose of the Discussion", 
        help="This message will be displayed to the agents at the beginning of the discussion, think of it as the 'prompt' to kick off the battle. You may also include guidelines as to how the agents should proceed with the discussion."
    )
